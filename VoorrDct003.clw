   ...
   MEMBER('VoorrDct.clw')                                  ! This is a MEMBER module
                     ...
                     MAP
                       INCLUDE('VOORRDCT003.INC'),ONCE        !Local module procedure declarations
                     END
...
! TEMPLATE: MT_Class_Declaration    
VoorraadClassSource Procedure  ! 
  CODE    
!--------------------------------------------------------------------
...
! Dummy Procedure definition
! TEMPLATE: MT_Class_Declaration    
GebruikerLogClassSource Procedure  ! 
  CODE    
!--------------------------------------------------------------------
!!! <summary>
!!! Generated from procedure template - Source
!!! </summary>
ExportInvoiceXML     PROCEDURE  (<VER:Record __p1>,<INK:Record __p2>,String __layout) ! Declare Procedure
ExportClass         CLASS
XMLHeader               PROCEDURE
XMLOrder                PROCEDURE
