...
ReturnValue          BYTE,AUTO
  ...
  CODE
        udpt.Init(UD,'FixEPlanning','Voorraad010.clw','Voorraad.EXE','07/01/2024 @ 05:23PM')    
...
ReturnValue          BYTE,AUTO
  ...
  IF BAND(Keystate(),KeyStateUD:Shift) 
        UD.ShowProcedureInfo('FixEPlanning',UD.SetApplicationName('Voorraad','EXE'),ProgressWindow{PROP:Hlp},'07/05/2010 @ 12:27PM','07/01/2024 @ 05:23PM','10/11/2024 @ 01:55PM')  
  ...
  IF Pla:PartijID > 0
  	...
  	IF (Access:Partij.TryFetch(Par:Partij_PK) = Level:Benign)
  		IF Par:ArtikelID <> Pla:ArtikelID THEN
  			UD.Debug('FixEPlanning - Geen Artikel Match' & Par:ArtikelID & '<>' & Pla:ArtikelID)
  			Pla:PartijID = 0
  			UD.Debug('FixEPlanning2')
  		.
  	ELSE
  		Pla:PartijID = 0
  	.
