   ...
   INCLUDE('ABREPORT.INC'),ONCE
                     ...
                     MAP
                       INCLUDE('VOORRAAD013.INC'),ONCE        !Local module procedure declarations
                     END


!!! <summary>
!!! Generated from procedure template - Process
!!! Process the Verkoop File
!!! </summary>
...
ProgressWindow       WINDOW('Process Verkoop'),AT(,,142,59),FONT('MS Sans Serif',8,,FONT:regular,CHARSET:DEFAULT), |
...
ReturnValue          BYTE,AUTO
  ...
  CODE
        udpt.Init(UD,'ConvertVerkoopStatus','Voorraad013.clw','Voorraad.EXE','07/01/2024 @ 05:23PM')    
...
ReturnValue          BYTE,AUTO
  ...
  END
  IF SELF.Opened
    INIMgr.Update('ConvertVerkoopStatus',ProgressWindow)   ! Save window data to non-volatile store
  END
  ProgressMgr.Kill()
  ...
  IF BAND(Keystate(),KeyStateUD:Shift) 
        UD.ShowProcedureInfo('ConvertVerkoopStatus',UD.SetApplicationName('Voorraad','EXE'),ProgressWindow{PROP:Hlp},'06/22/2010 @ 10:17AM','07/01/2024 @ 05:23PM','10/11/2024 @ 01:55PM')  
