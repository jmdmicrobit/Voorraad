...
ReturnValue          BYTE,AUTO
  ...
  CODE
        udpt.Init(UD,'WindowInslag','VoorrPln019.clw','VoorrPln.DLL','06/28/2024 @ 01:22PM')    
  ...
  ELSIF ThisWindow.Request = ChangeRecord OR ThisWindow.Request = ViewRecord
      ! Dit kan een change zijn van de Inslag maar als er nog geen mutaties daarom heb ik deze nodig 
  	Access:APlanning.TryFetch(APla:PK_Planning)
  
  	! APlanning wordt vanuit de mutatie opgehaald
  	DO MutatieToLokaal
  	
  	db.DebugOut('Partij-init: ' & APla:InkoopID & ', ' & APla:PlanningID)  ! 2021-8-5 Hier gaat ie fout als ie van de PLA: komt.....
  	Par:InkoopID = APla:InkoopID
  	Par:InkoopPlanningID = APla:PlanningID
  ...
  If event() = event:VisibleOnDesktop !or event() = event:moved
    ds_VisibleOnDesktop()
     ...
     IF KEYCODE()=CtrlShiftP  
        UD.ShowProcedureInfo('WindowInslag',UD.SetApplicationName('VoorrPln','DLL'),Window{PROP:Hlp},'10/06/2011 @ 04:06PM','06/28/2024 @ 01:22PM','10/11/2024 @ 01:54PM')  
