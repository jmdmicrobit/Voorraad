...
ReturnValue          BYTE,AUTO
  ...
  CODE
        udpt.Init(UD,'BrowseOverboeking','VoorrPln033.clw','VoorrPln.DLL','06/01/2021 @ 01:42PM')    
  ...
  If event() = event:VisibleOnDesktop !or event() = event:moved
    ds_VisibleOnDesktop()
     ...
     IF KEYCODE()=CtrlShiftP  
        UD.ShowProcedureInfo('BrowseOverboeking',UD.SetApplicationName('VoorrPln','DLL'),QuickWindow{PROP:Hlp},'10/06/2011 @ 04:10PM','06/01/2021 @ 01:42PM','10/11/2024 @ 01:55PM')  
...
_starttijd              TIME
  ...
  IF ReturnValue
      LogSetSort('Overboeking','NewOrder: '&NewOrder&' Force: '&Force& ' ReturnValue: '&ReturnValue&' '&(Clock()-_starttijd)/100&' sec')
  END
  RETURN ReturnValue
