   ...
   INCLUDE('ABWINDOW.INC'),ONCE
                     ...
                     MAP
                       INCLUDE('VOORRPLN021.INC'),ONCE        !Local module procedure declarations
                     END
...
QuickWindow          WINDOW('Uitslag Weging'),AT(,,784,424),FONT('MS Sans Serif',8,,,CHARSET:DEFAULT),DOUBLE,AUTO, |
  CENTER,GRAY,IMM,MDI,HLP('UpdateUitslagMutatie'),SYSTEM
  ...
  ')@n-14@200L(2)|~Locatie Naam~@s50@'),FROM(GLO:UitslagMutatieQueue)
                       ...
                       LIST,AT(337,106,266,27),USE(?WegingList1),VSCROLL,FORMAT('42R(2)|~Bruto (KG)~C(0)@n14`2' & |
  '@35C|~Palletsoort~@s10@0C(2)@n-14@42R(2)|~Netto (KG)~C(0)@n14`2@0R(2)@d17@0R(2)@t7@0' & |
  'R(2)|~Pallet-ID~C(1)@n_10@40R(2)|~Production~C(0)@d6-@40R(2)|~THT~C(0)@d6-@40R(2)|~H' & |
  'arvast~C(0)@d6-@'),FROM(LOC:WegingQueue1)
  ...
  '@45C|~Palletsoort~@s10@0L(2)@n-14@60R(2)|~Netto (KG)~C(0)@n14`2@0R@d17@0R@t7@0R(2)|~' & |
  'Pallet-ID~C(1)@n_10@40R(2)|~Production~C(0)@d6-@40R(2)|~THT~C(0)@d6-@40R(2)|~Harvast' & |
  '~C(0)@d6-@'),FROM(LOC:WegingQueue2)
  ...
  '@45C|~Palletsoort~@s10@0L(2)@n-14@60R(2)|~Netto (KG)~C(0)@n14`2@0R(2)@d17@0R(2)@t7@0' & |
  'R(2)|~Pallet-ID~C(1)@n_10@40R(2)|~Production~C(0)@d6-@40R(2)|~THT~C(0)@d6-@40R(2)|~H' & |
  'arvast~C(0)@d6-@'),FROM(LOC:WegingQueue3)
  ...
  '@45C|~Palletsoort~@s10@0L(2)@n-14@60R(2)|~Netto (KG)~C(0)@n14`2@0R(2)@d17@0R(2)@t7@0' & |
  'R(2)|~Pallet-ID~C(1)@n_10@40R(2)|~Production~C(0)@d6-@40R(2)|~THT~C(0)@d6-@40R(2)|~H' & |
  'arvast~C(0)@d6-@'),FROM(LOC:WegingQueue4)
...
? DEBUGHOOK(AAAViewVoorraadPartij:Record)
? DEBUGHOOK(AACelLocatie:Record)
? DEBUGHOOK(AAViewVoorraadPartij:Record)
...
ReturnValue          BYTE,AUTO
  ...
  CODE
        udpt.Init(UD,'UpdateUitslagMutatieWeging','VoorrPln021.clw','VoorrPln.DLL','07/10/2024 @ 02:23PM')    
  ...
  SELF.Open(QuickWindow)                                   ! Open window
      ...
      IF Self.Request=ChangeRecord OR SELF.Request = ViewRecord
  		...
  		LOOP
            ...
            WGQ1:ProductionDate = Weg:ProductionDate_DATE
            WGQ1:THTDate = Weg:THTDate_DATE
            WGQ1:HarvastDate = Weg:HarvastDate_DATE
  		...
  		IF (Mut:PlanningID <> 0)
            ...
            WGQ2:ProductionDate = Weg:ProductionDate_DATE
            WGQ2:THTDate = Weg:THTDate_DATE
            WGQ2:HarvastDate = Weg:HarvastDate_DATE
            ...
            WGQ3:ProductionDate = Weg:ProductionDate_DATE
            WGQ3:THTDate = Weg:THTDate_DATE
            WGQ3:HarvastDate = Weg:HarvastDate_DATE
            ...
            WGQ4:ProductionDate = Weg:ProductionDate_DATE
            WGQ4:THTDate = Weg:THTDate_DATE
            WGQ4:HarvastDate = Weg:HarvastDate_DATE
            ...
            GWQ2:ProductionDate = Weg:ProductionDate_DATE
            GWQ2:THTDate = Weg:THTDate_DATE
            GWQ2:HarvastDate = Weg:HarvastDate_DATE
  ...
  LOOP                                                     ! This method receive all EVENT:Accepted's
    ...
    OF ?WijzigenWeging1
      ...
      IF NOT(ERROR()) THEN
          ...
          WGQ:Tijd = WGQ1:Tijd
          WGQ:ProductionDate = WGQ1:ProductionDate
          WGQ:THTDate = WGQ1:THTDate
          WGQ:HarvastDate = WGQ1:HarvastDate
  ...
  ReturnValue = PARENT.TakeAccepted()
    ...
    OF ?WeegNu1
      ...
      IF GLOBALResponse = RequestCompleted THEN
          LOOP i# = 1 TO RECORDS(GLO:WegingQueue)
              ...
              WGQ1:ProductionDate = WGQ:ProductionDate
              WGQ1:THTDate = WGQ:THTDate
              WGQ1:HarvastDate = WGQ:HarvastDate
              ADD(LOC:WegingQueue1)
          .
          
          IF NOT GLO:UitslagPalletbladOriginLiveBird=Mut:UitslagPalletbladOriginLiveBird AND GLO:UitslagPalletbladOriginLiveBird <> ''
              MUT:UitslagPalletbladOriginLiveBird=GLO:UitslagPalletbladOriginLiveBird
          END
          IF NOT GLO:UitslagPalletbladOriginSlautherHouse=Mut:UitslagPalletbladOriginSlautherHouse AND GLO:UitslagPalletbladOriginSlautherHouse <>''
              MUT:UitslagPalletbladOriginSlautherHouse=GLO:UitslagPalletbladOriginSlautherHouse
          END
          IF NOT GLO:UitslagPalletbladOriginProcessing=Mut:UitslagPalletbladOriginProcessing AND GLO:UitslagPalletbladOriginProcessing<>''
              MUT:UitslagPalletbladOriginProcessing=GLO:UitslagPalletbladOriginProcessing
          END
          IF NOT GLO:UitslagPalletbladOriginPacking=Mut:UitslagPalletbladOriginPacking AND GLO:UitslagPalletbladOriginPacking<>''
    ...
    OF ?WijzigenWeging2
      ...
      IF GLOBALResponse = RequestCompleted THEN
      	...
      	WGQ2:Tijd = WGQ:Tijd
          WGQ2:ProductionDate = WGQ:ProductionDate
          WGQ2:THTDate = WGQ:THTDate
          WGQ2:HarvastDate = WGQ:HarvastDate
    ...
    OF ?WeegNu2
      ...
      IF GLOBALResponse = RequestCompleted THEN
          ...
          IF NOT GLO:UitslagPalletbladOriginSlautherHouse=Mut:UitslagPalletbladOriginSlautherHouse AND GLO:UitslagPalletbladOriginSlautherHouse <>''
              MUT:UitslagPalletbladOriginSlautherHouse=GLO:UitslagPalletbladOriginSlautherHouse
          END
          IF GLO:UitslagPalletbladOriginProcessing=Mut:UitslagPalletbladOriginProcessing AND GLO:UitslagPalletbladOriginProcessing<>''
              MUT:UitslagPalletbladOriginProcessing=GLO:UitslagPalletbladOriginProcessing
          END
          IF GLO:UitslagPalletbladOriginPacking=Mut:UitslagPalletbladOriginPacking AND GLO:UitslagPalletbladOriginPacking<>''
              MUT:UitslagPalletbladOriginPacking=GLO:UitslagPalletbladOriginPacking
          END
    ...
    OF ?WeegNu3
      ...
      IF GLOBALResponse = RequestCompleted THEN
          LOOP i# = 1 TO RECORDS(GLO:WegingQueue)
              ...
              WGQ3:ProductionDate = WGQ:ProductionDate
              WGQ3:THTDate = WGQ:THTDate
              WGQ3:HarvastDate = WGQ:HarvastDate
              ADD(LOC:WegingQueue3)
          .
          IF NOT GLO:UitslagPalletbladOriginLiveBird=Mut:UitslagPalletbladOriginLiveBird AND GLO:UitslagPalletbladOriginLiveBird <> ''
              MUT:UitslagPalletbladOriginLiveBird=GLO:UitslagPalletbladOriginLiveBird
    ...
    OF ?ToevoegenWeging3
      ...
      IF GLOBALResponse = RequestCompleted THEN
          ...
          WGQ4:ProductionDate = WGQ:ProductionDate
          WGQ4:THTDate = WGQ:THTDate
          WGQ4:HarvastDate = WGQ:HarvastDate
      	ADD(LOC:WegingQueue3)
      .
    OF ?WijzigenWeging3
      ThisWindow.Update()
    ...
    OF ?PalletbladButton
      ...
      IF NOT(ERROR()) THEN
          SELF.VulUitslagPalletBlad(1)
          IF WGQ1:ProductionDate
              GLO:UitslagPalletbladProductionDate11 = WGQ1:ProductionDate
          END
          IF WGQ1:THTDate
              GLO:UitslagPalletbladSellByDate15 = WGQ1:THTDate
          END
          IF WGQ1:HarvastDate
              GLO:UitslagPalletbladHarvastDate7007 = WGQ1:HarvastDate
          END
    ...
    OF ?PalletbladButton2
      ...
      IF NOT(ERROR()) THEN
          SELF.VulUitslagPalletBlad(2)
          IF WGQ2:ProductionDate
              GLO:UitslagPalletbladProductionDate11 = WGQ2:ProductionDate
          END
          IF WGQ2:THTDate
              GLO:UitslagPalletbladSellByDate15 = WGQ2:THTDate
          END
          IF WGQ2:HarvastDate
              GLO:UitslagPalletbladHarvastDate7007 = WGQ2:HarvastDate
          END
    ...
    OF ?PalletbladButton3
      ...
      IF NOT(ERROR()) THEN
          SELF.VulUitslagPalletBlad(3)
          IF WGQ3:ProductionDate
              GLO:UitslagPalletbladProductionDate11 = WGQ3:ProductionDate
          END
          IF WGQ3:THTDate
              GLO:UitslagPalletbladSellByDate15 = WGQ3:THTDate
          END
          IF WGQ3:HarvastDate
              GLO:UitslagPalletbladHarvastDate7007 = WGQ3:HarvastDate
          END
    ...
    OF ?PalletbladButton4
      ...
      IF NOT(ERROR()) THEN
          SELF.VulUitslagPalletBlad(4)
          IF WGQ4:ProductionDate
              GLO:UitslagPalletbladProductionDate11 = WGQ4:ProductionDate
          END
          IF WGQ4:THTDate
              GLO:UitslagPalletbladSellByDate15 = WGQ4:THTDate
          END
          IF WGQ4:HarvastDate
              GLO:UitslagPalletbladHarvastDate7007 = WGQ4:HarvastDate
          END
...
Looped BYTE
  ...
  LOOP i# = 1 TO RECORDS(LOC:WegingQueue1)
      ...
      Weg:PalletID = WGQ1:PalletID
            Weg:ProductionDate_DATE = WGQ1:ProductionDate
             Weg:THTDate_DATE = WGQ1:THTDate 
             Weg:HarvastDate_DATE = WGQ1:HarvastDate 
  ...
  IF LOC:PartijCelID2<>'' AND (LOC:UitslagPallet2<>0 OR LOC:UitslagKG2<>0)
  	...
  	LOOP i# = 1 TO RECORDS(LOC:WegingQueue2)
          ...
          Weg:PalletID = WGQ2:PalletID
            Weg:ProductionDate_DATE = WGQ2:ProductionDate
             Weg:THTDate_DATE = WGQ2:THTDate 
             Weg:HarvastDate_DATE = WGQ2:HarvastDate 
  		Access:Weging.Insert()
  	END
  END
  ...
  IF LOC:PartijCelID3<>'' AND (LOC:UitslagPallet3<>0 OR LOC:UitslagKG3<>0)
  	...
  	LOOP i# = 1 TO RECORDS(LOC:WegingQueue3)
          ...
          Weg:PalletID = WGQ3:PalletID
            Weg:ProductionDate_DATE = WGQ3:ProductionDate
             Weg:THTDate_DATE = WGQ3:THTDate 
             Weg:HarvastDate_DATE = WGQ3:HarvastDate 
          Access:Weging.Insert()
  	END
  END
  ...
  IF LOC:PartijCelID4<>'' AND (LOC:UitslagPallet4<>0 OR LOC:UitslagKG4<>0)
  	...
  	LOOP i# = 1 TO RECORDS(LOC:WegingQueue4)
          ...
          Weg:PalletID = WGQ4:PalletID
            Weg:ProductionDate_DATE = WGQ4:ProductionDate
             Weg:THTDate_DATE = WGQ4:THTDate 
             Weg:HarvastDate_DATE = WGQ4:HarvastDate 
  		Access:Weging.Insert()
  	END
  END
  	...
  	IF UMQ:PartijCelID<>'' AND (UMQ:Pallet<>0 OR UMQ:KG<>0)
  		...
  		LOOP j# = 1 TO RECORDS(GLO:WegingQueue2)
  			...
  			IF (GWQ2:ID = i#) THEN
                ...
                Weg:ProductionDate_DATE = GWQ2:ProductionDate
                Weg:THTDate_DATE = GWQ2:THTDate
                Weg:HarvastDate_DATE = GWQ2:HarvastDate
  				Access:Weging.Insert()
  			END
  		END
  	.
  ...
  If event() = event:VisibleOnDesktop !or event() = event:moved
    ds_VisibleOnDesktop()
     ...
     IF KEYCODE()=CtrlShiftP  
        UD.ShowProcedureInfo('UpdateUitslagMutatieWeging',UD.SetApplicationName('VoorrPln','DLL'),QuickWindow{PROP:Hlp},'10/06/2011 @ 04:06PM','07/10/2024 @ 02:23PM','10/11/2024 @ 01:54PM')  
