   ...
   INCLUDE('ABWINDOW.INC'),ONCE
                     ...
                     MAP
                       INCLUDE('VOORRPLN015.INC'),ONCE        !Local module procedure declarations
                     END
...
QuickWindow          WINDOW('Planning'),AT(,,851,396),FONT('MS Sans Serif',8,,,CHARSET:DEFAULT),RESIZE,MAXIMIZE, |
  CENTER,GRAY,MAX,MDI,HLP('BrowsePlanning'),SYSTEM,TIMER(100),IMM
  ...
  'port~C(0)@s100@50R(2)|M*~Planning-ID~C(2)@n_10@'),FROM(Queue:Browse:3),IMM
                           ...
                           BUTTON('Palletstickers'),AT(365,356,57,14),USE(?InkoopPrint2),COLOR(0000D7FFh)
                           ...
                           BUTTON('Inslag-rapport'),AT(302,356),USE(?InslagRapportButton2),COLOR(0000D7FFh)
                           BUTTON('Terugdraaien'),AT(178,356),USE(?InkoopTerugdraaien2),COLOR(00EBCE87h)
                           BUTTON('Kwaliteit'),AT(240,356,58,14),USE(?InkoopKwaliteit),COLOR(00EBCE87h)
                         END
...
? DEBUGHOOK(APlanningInkoop:Record)
? DEBUGHOOK(APlanningOverboeking:Record)
? DEBUGHOOK(APlanningVerkoop:Record)
...
ReturnValue          BYTE,AUTO
  ...
  CODE
        udpt.Init(UD,'BrowsePlanning','VoorrPln015.clw','VoorrPln.DLL','12/22/2023 @ 01:45PM')    
  ...
  Loc:KwaliteitKnopVerbergen=GETINI('SYSTEEM','KwaliteitKnopVerbergen',True,PQ:IniFile)
  ...
  BRW11.AskProcedure = 48                                  ! Will call: UpdateActiviteit((LOC:DatumNu))
...
ThisWindow.Reset PROCEDURE(BYTE Force=0)
  ...
  IF QuickWindow{Prop:AcceptAll} THEN RETURN.
    NetLocalRefreshDate = today()         ! NetTalk (NetRefresh)
    NetLocalRefreshTime = clock()
  !  UD.Debug('ThisWindow.Reset('&Force&')')
  PARENT.Reset(Force)
...
Looped BYTE
  ...
  LOOP                                                     ! This method receive all EVENT:Accepted's
    ...
    OF ?InkoopInslag
      ...
      GLO:GebruikerLogHandelingOpmerking = 'InkoopInslaan Tab:Planning'
      ...
      IF Access:Partij.TryFetch(Par:Partij_PK) = Level:Benign
          ...
          IF GlobalResponse = RequestCompleted
              ...
              IF Access:APlanning.Fetch(APla:PK_Planning)
                  Message('Planning regel kan niet ingelezen worden','Fout',Icon:Hand)
              END
              GLO:GebruikerLogHandelingOpmerking = 'InkoopInslaan After Change APla:MutatieGemaakt'
      ...
      ELSE
      	...
      	IF GlobalResponse = RequestCompleted
              ...
              IF Access:APlanning.Fetch(APla:PK_Planning)
                  Message('Planning regel kan niet ingelezen worden','Fout',Icon:Hand)
              END
              GLO:GebruikerLogHandelingOpmerking = 'InkoopInslaan After Insert APla:MutatieGemaakt'
      		APla:MutatieGemaakt = TRUE
    ...
    OF ?InkoopVerwerk
      ...
      IF Access:Partij.TryFetch(Par:Partij_PK) = Level:Benign
      	...
      	IF GlobalResponse = RequestCompleted
              ! Planningrecord inlezen
      		GLO:GebruikerLogHandelingOpmerking = 'InkoopVerwerkt After '	
      		!GlobalRequest = ChangeRecord
      		!UpdateInslag
      		!IF GlobalResponse = RequestCompleted
    ...
    OF ?InkoopTerugdraaien2
      GLO:GebruikerLogHandelingOpmerking = 'InkoopTerugdraaien Tab:Inkoop'
  ...
  ReturnValue = PARENT.TakeAccepted()
    ...
    OF ?InkoopTerugdraaienButton
      ThisWindow.Update()
      GLO:GebruikerLogHandelingOpmerking = 'InkoopTerugdraaien  Tab:Planning'
    ...
    OF ?InkoopInslag2
      ...
      GLO:GebruikerLogHandelingOpmerking = 'InkoopInslaan Tab:Inkoop'
  ...
  If event() = event:VisibleOnDesktop !or event() = event:moved
    ds_VisibleOnDesktop()
     ...
     IF KEYCODE()=CtrlShiftP  
        UD.ShowProcedureInfo('BrowsePlanning',UD.SetApplicationName('VoorrPln','DLL'),QuickWindow{PROP:Hlp},'10/06/2011 @ 04:06PM','12/22/2023 @ 01:45PM','10/11/2024 @ 01:54PM')  
