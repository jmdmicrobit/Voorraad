   ...
   INCLUDE('ABWINDOW.INC'),ONCE
                     ...
                     MAP
                       INCLUDE('VOORRPLN029.INC'),ONCE        !Local module procedure declarations
                     END
...
ReturnValue          BYTE,AUTO
  ...
  CODE
        udpt.Init(UD,'BulkOverboekMutatieMaken','VoorrPln029.clw','VoorrPln.DLL','06/28/2024 @ 01:22PM')    
  ...
  If event() = event:VisibleOnDesktop !or event() = event:moved
    ds_VisibleOnDesktop()
     ...
     IF KEYCODE()=CtrlShiftP  
        UD.ShowProcedureInfo('BulkOverboekMutatieMaken',UD.SetApplicationName('VoorrPln','DLL'),QuickWindow{PROP:Hlp},'10/06/2011 @ 04:06PM','06/28/2024 @ 01:22PM','10/11/2024 @ 01:54PM')  
