   ...
   INCLUDE('ABWINDOW.INC'),ONCE
                     ...
                     MAP
                       INCLUDE('VOORRSTM001.INC'),ONCE        !Local module procedure declarations
                     END
...
ReturnValue          BYTE,AUTO
  ...
  CODE
  GlobalErrors.SetProcedureName('MainStm')
  ...
  INIMgr.Fetch('MainStm',Window)                           ! Restore window settings from non-volatile store
  SELF.SetAlerts()
...
ReturnValue          BYTE,AUTO
  ...
  END
  IF SELF.Opened
    INIMgr.Update('MainStm',Window)                        ! Save window data to non-volatile store
  END
