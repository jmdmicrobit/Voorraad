  ...
  If event() = event:VisibleOnDesktop !or event() = event:moved
    ds_VisibleOnDesktop()
     ...
     IF KEYCODE()=CtrlShiftP  
        UD.ShowProcedureInfo('BrowseDubbeleInslagMutaties',UD.SetApplicationName('Voorraad','EXE'),QuickWindow{PROP:Hlp},'10/04/2010 @ 12:32PM','04/03/2014 @ 03:29PM','10/11/2024 @ 01:55PM')  
