...
ReturnValue          BYTE,AUTO
  ...
  CODE
        udpt.Init(UD,'UpdateOverboekingMutatieQueue','VoorrPln026.clw','VoorrPln.DLL','09/04/2014 @ 03:07PM')    
  ...
  If event() = event:VisibleOnDesktop !or event() = event:moved
    ds_VisibleOnDesktop()
     ...
     IF KEYCODE()=CtrlShiftP  
        UD.ShowProcedureInfo('UpdateOverboekingMutatieQueue',UD.SetApplicationName('VoorrPln','DLL'),Window{PROP:Hlp},'04/05/2013 @ 05:14PM','09/04/2014 @ 03:07PM','10/11/2024 @ 01:54PM')  
