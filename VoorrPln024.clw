...
QuickWindow          WINDOW('Form Mutatie'),AT(,,684,434),FONT('MS Sans Serif',8,,,CHARSET:DEFAULT),DOUBLE,CENTER, |
  ...
  'rpakking~C(0)@s50@50L(2)|~Leverancier~C(0)@s50@'),FROM(Queue:FileDropCombo:1),IMM
                       ...
                       ENTRY(@n-12_`2),AT(365,126,54,10),USE(Mut:UitslagKG),RIGHT
                       ENTRY(@n-11.),AT(432,126,60,10),USE(Mut:UitslagPallet),RIGHT
  ...
  TIP('Cancel operation')
                       ENTRY(@n-11.),AT(431,108,60,10),USE(LOC:TotaalUitslagPallet),RIGHT
                       ENTRY(@n-12_`2),AT(364,108,54,10),USE(LOC:TotaalUitslagKG),RIGHT
...
ReturnValue          BYTE,AUTO
  ...
  CODE
        udpt.Init(UD,'UpdateUitslagMutatie','VoorrPln024.clw','VoorrPln.DLL','06/28/2024 @ 01:22PM')    
  	...
  	IF Self.Request=ChangeRecord OR SELF.Request = ViewRecord
  		...
  		IF (Mut:PlanningID <> 0)
  		   ...
  		   LOOP
  			   ...
  			   LOC:OrigineelPartijCelID[LOC:AantalOrigineel]=CLIP(FORMAT(AMut:PartijID, @N05)) & '.' & CLIP(AMut:CelID)
  			   ...
  			   OF 2
  				   ...
  				   LOC:UitslagKG2 = AMut:UitslagKG
                      ...
                      AVVPar:PartijCelID = LOC:PartijCelID2           ! omdat deze pas verschijnt als je ergens op klikt
                      !DISPLAY(?AVVPar:PartijCelID)
  			   OF 3
  ...
  If event() = event:VisibleOnDesktop !or event() = event:moved
    ds_VisibleOnDesktop()
     ...
     IF KEYCODE()=CtrlShiftP  
        UD.ShowProcedureInfo('UpdateUitslagMutatie',UD.SetApplicationName('VoorrPln','DLL'),QuickWindow{PROP:Hlp},'10/06/2011 @ 04:06PM','06/28/2024 @ 01:22PM','10/11/2024 @ 01:54PM')  
