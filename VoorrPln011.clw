   ...
   INCLUDE('ABWINDOW.INC'),ONCE
                     ...
                     MAP
                       INCLUDE('VOORRPLN011.INC'),ONCE        !Local module procedure declarations
                     END
...
VVPar:PartijCelID_NormalFG LONG                       !Normal forground color
VVPar:PartijCelID_NormalBG LONG                       !Normal background color
VVPar:PartijCelID_SelectedFG LONG                     !Selected forground color
VVPar:PartijCelID_SelectedBG LONG                     !Selected background color
...
VVPar:BerekendeInkoopKGPrijs_NormalFG LONG            !Normal forground color
VVPar:BerekendeInkoopKGPrijs_NormalBG LONG            !Normal background color
VVPar:BerekendeInkoopKGPrijs_SelectedFG LONG          !Selected forground color
VVPar:BerekendeInkoopKGPrijs_SelectedBG LONG          !Selected background color
...
LOC:PartijVerkoopKG_NormalFG LONG                     !Normal forground color
LOC:PartijVerkoopKG_NormalBG LONG                     !Normal background color
LOC:PartijVerkoopKG_SelectedFG LONG                   !Selected forground color
LOC:PartijVerkoopKG_SelectedBG LONG                   !Selected background color
LOC:BeschikbarePartijVoorraad LIKE(LOC:BeschikbarePartijVoorraad) !List box control field - type derived from local data
LOC:BeschikbarePartijVoorraad_NormalFG LONG           !Normal forground color
LOC:BeschikbarePartijVoorraad_NormalBG LONG           !Normal background color
LOC:BeschikbarePartijVoorraad_SelectedFG LONG         !Selected forground color
LOC:BeschikbarePartijVoorraad_SelectedBG LONG         !Selected background color
...
VVPar:Locatienaam_NormalFG LONG                       !Normal forground color
VVPar:Locatienaam_NormalBG LONG                       !Normal background color
VVPar:Locatienaam_SelectedFG LONG                     !Selected forground color
VVPar:Locatienaam_SelectedBG LONG                     !Selected background color
...
LOC:VerkoopKG_NormalFG LONG                           !Normal forground color
LOC:VerkoopKG_NormalBG LONG                           !Normal background color
LOC:VerkoopKG_SelectedFG LONG                         !Selected forground color
LOC:VerkoopKG_SelectedBG LONG                         !Selected background color
LOC:BeschikbareVoorraad LIKE(LOC:BeschikbareVoorraad) !List box control field - type derived from local data
LOC:BeschikbareVoorraad_NormalFG LONG                 !Normal forground color
LOC:BeschikbareVoorraad_NormalBG LONG                 !Normal background color
LOC:BeschikbareVoorraad_SelectedFG LONG               !Selected forground color
LOC:BeschikbareVoorraad_SelectedBG LONG               !Selected background color
...
QuickWindow          WINDOW('Form Planning'),AT(,,497,360),FONT('MS Sans Serif',8,,,CHARSET:DEFAULT),DOUBLE,CENTER, |
  GRAY,IMM,MDI,HLP('UpdatePlanning'),SYSTEM
                       SHEET,AT(4,4,491,337),USE(?CurrentTab)
                         TAB('&1) Verkoop-regel'),USE(?Tab:1)
                           ...
                           COMBO(@s60),AT(69,27,282,10),USE(Art:ArtikelOms),DROP(25),FORMAT('187L(2)|M~Omschrijvin' & |
  'g~@s60@120L(2)|M~ID~@s30@'),FROM(Queue:FileDropCombo),IMM
  ...
  LEFT,ICON('WAChange.ico')
                           ...
                           COMBO(@s25),AT(69,87,177,10),USE(VVPar:PartijCelID),HVSCROLL,DROP(25,800),FORMAT('50L(2)|*~P' & |
  'artij.Cel~C(0)@s25@0L(2)~Partij ID~C(0)@n_10@[39R(2)|M*~Intern~C(0)@n_10@60R(2)|M*~E' & |
  'xtern~C(1)@s20@](78)|~Partijnummer~0L(2)~Cel ID~C(1)@n_10@44L(2)|*~Inslagdatum~C(0)@' & |
  'd17@52R(2)|*~Inkoop KG-Prijs~C(0)@n13`3@[49R(2)|*Y~Voorraad~C(0)@n-12`2@65R(2)|*~Gep' & |
  'lande Verkoop~C(0)@n-14`2@60R(2)|*~Beschikbaar~D(12)@n-14`2@](171)|~KG (Partij)~[40L' & |
  '(2)|M*~Cel~C(0)@s50@20L(2)|M*@s50@]|~Cel~[43R(2)|M*~Voorraad~C(0)@n-12`2@Z(1)62R(2)|' & |
  'M*~Geplande Verkoop~C(0)@n-13`2@Z(1)56R(2)|M*~Beschikbaar~C(0)@n-13`2@Z(1)](160)|~KG' & |
  ' (Cel)~74L(2)|M*~Leverancier~C(0)@s50@80L(2)|M*~Verpakking~C(0)@s50@'),FROM(Queue:FileDropCombo:3), |
  IMM
  ...
  '(2)|M~Benaming NL~L(0)@s100@'),FROM(Queue:FileDrop)
                           STRING(@S10),AT(8,134),USE(PQ:StandaardEenheid)
                         END
...
ReturnValue          BYTE,AUTO
  ...
  CODE
        udpt.Init(UD,'UpdatePlanningVerkoop','VoorrPln011.clw','VoorrPln.DLL','10/11/2024 @ 01:51PM')    
  ...
  FDCB4.AddField(VVPar:Blokkade_DATE,FDCB4.Q.VVPar:Blokkade_DATE) !Browse hot field - type derived from field
  FDCB4.AddField(VVPar:deBlokkade_DATE,FDCB4.Q.VVPar:deBlokkade_DATE) !Browse hot field - type derived from field
...
ReturnValue          BYTE,AUTO
  ...
  CODE
  UD.Debug('Voor het verwijderen van de Verkoopplanning regel Pla:Verwerkt'&Pla:Verwerkt & ' Pla:MutatieGemaakt: '&Pla:MutatieGemaakt)
  
  IF Pla:Verwerkt OR Pla:MutatieGemaakt
      Message('Let op deze rege is al verwerkt en/of er is een mutatie gemaakt en kan dan niet verwijderd worden','Controle Verwijdering',Icon:Cross)
      Return Level:Cancel
  END
  ...
  END
  UD.Debug('Na de Parent-call: ReturnValue: '& ReturnValue&' Pla:PlanningIDParent: '& Pla:PlanningIDParent) 
  IF ReturnValue=RequestCompleted
      Clear(APla:Record)
      APla:PlanningID = Pla:PlanningIDParent
      IF Access:APlanning.Fetch(APla:PK_Planning)=Level:Benign
          UD.Debug('Parent Record gevonden nu Retour leegmasken '&APla:PlanningIDRetour)    
          CLEAR(APla:PlanningIDRetour)
  ...
  If event() = event:VisibleOnDesktop !or event() = event:moved
    ds_VisibleOnDesktop()
     ...
     IF KEYCODE()=CtrlShiftP  
        UD.ShowProcedureInfo('UpdatePlanningVerkoop',UD.SetApplicationName('VoorrPln','DLL'),QuickWindow{PROP:Hlp},'10/06/2011 @ 04:10PM','10/11/2024 @ 01:51PM','10/11/2024 @ 01:54PM')  
...
FDCB4.SetQueueRecord PROCEDURE
  ...
  IF (VVPar:Blokkade_DATE<>0 AND VVPar:deBlokkade_DATE=0)
    SELF.Q.VVPar:PartijCelID_NormalFG = -1                 ! Set conditional color values for VVPar:PartijCelID
    SELF.Q.VVPar:PartijCelID_NormalBG = 255
    SELF.Q.VVPar:PartijCelID_SelectedFG = 255
    SELF.Q.VVPar:PartijCelID_SelectedBG = -1
    SELF.Q.Par:PartijID_NormalFG = -1                      ! Set conditional color values for Par:PartijID
    SELF.Q.Par:PartijID_NormalBG = 255
    SELF.Q.Par:PartijID_SelectedFG = 255
    SELF.Q.Par:PartijID_SelectedBG = -1
    SELF.Q.Par:ExternPartijnr_NormalFG = -1                ! Set conditional color values for Par:ExternPartijnr
    SELF.Q.Par:ExternPartijnr_NormalBG = 255
    SELF.Q.Par:ExternPartijnr_SelectedFG = 255
    SELF.Q.Par:ExternPartijnr_SelectedBG = -1
    SELF.Q.Par:AanmaakDatum_DATE_NormalFG = -1             ! Set conditional color values for Par:AanmaakDatum_DATE
    SELF.Q.Par:AanmaakDatum_DATE_NormalBG = 255
    SELF.Q.Par:AanmaakDatum_DATE_SelectedFG = 255
    SELF.Q.Par:AanmaakDatum_DATE_SelectedBG = -1
    SELF.Q.VVPar:BerekendeInkoopKGPrijs_NormalFG = -1      ! Set conditional color values for VVPar:BerekendeInkoopKGPrijs
    SELF.Q.VVPar:BerekendeInkoopKGPrijs_NormalBG = 255
    SELF.Q.VVPar:BerekendeInkoopKGPrijs_SelectedFG = 255
    SELF.Q.VVPar:BerekendeInkoopKGPrijs_SelectedBG = -1
    SELF.Q.VVParT:VoorraadKG_NormalFG = -1                 ! Set conditional color values for VVParT:VoorraadKG
    SELF.Q.VVParT:VoorraadKG_NormalBG = 255
    SELF.Q.VVParT:VoorraadKG_SelectedFG = 255
    SELF.Q.VVParT:VoorraadKG_SelectedBG = -1
    SELF.Q.LOC:PartijVerkoopKG_NormalFG = -1               ! Set conditional color values for LOC:PartijVerkoopKG
    SELF.Q.LOC:PartijVerkoopKG_NormalBG = 255
    SELF.Q.LOC:PartijVerkoopKG_SelectedFG = 255
    SELF.Q.LOC:PartijVerkoopKG_SelectedBG = -1
    SELF.Q.LOC:BeschikbarePartijVoorraad_NormalFG = -1     ! Set conditional color values for LOC:BeschikbarePartijVoorraad
    SELF.Q.LOC:BeschikbarePartijVoorraad_NormalBG = 255
    SELF.Q.LOC:BeschikbarePartijVoorraad_SelectedFG = 255
    SELF.Q.LOC:BeschikbarePartijVoorraad_SelectedBG = -1
    SELF.Q.ACel:CelOms_NormalFG = -1                       ! Set conditional color values for ACel:CelOms
    SELF.Q.ACel:CelOms_NormalBG = 255
    SELF.Q.ACel:CelOms_SelectedFG = 255
    SELF.Q.ACel:CelOms_SelectedBG = -1
    SELF.Q.VVPar:Locatienaam_NormalFG = -1                 ! Set conditional color values for VVPar:Locatienaam
    SELF.Q.VVPar:Locatienaam_NormalBG = 255
    SELF.Q.VVPar:Locatienaam_SelectedFG = 255
    SELF.Q.VVPar:Locatienaam_SelectedBG = -1
    SELF.Q.VVPar:VoorraadKG_NormalFG = -1                  ! Set conditional color values for VVPar:VoorraadKG
    SELF.Q.VVPar:VoorraadKG_NormalBG = 255
    SELF.Q.VVPar:VoorraadKG_SelectedFG = 255
    SELF.Q.VVPar:VoorraadKG_SelectedBG = -1
    SELF.Q.LOC:VerkoopKG_NormalFG = -1                     ! Set conditional color values for LOC:VerkoopKG
    SELF.Q.LOC:VerkoopKG_NormalBG = 255
    SELF.Q.LOC:VerkoopKG_SelectedFG = 255
    SELF.Q.LOC:VerkoopKG_SelectedBG = -1
    SELF.Q.LOC:BeschikbareVoorraad_NormalFG = -1           ! Set conditional color values for LOC:BeschikbareVoorraad
    SELF.Q.LOC:BeschikbareVoorraad_NormalBG = 255
    SELF.Q.LOC:BeschikbareVoorraad_SelectedFG = 255
    SELF.Q.LOC:BeschikbareVoorraad_SelectedBG = -1
    ...
    SELF.Q.AVP:VerpakkingOmschrijving_NormalFG = -1        ! Set conditional color values for AVP:VerpakkingOmschrijving
    SELF.Q.AVP:VerpakkingOmschrijving_NormalBG = 255
    SELF.Q.AVP:VerpakkingOmschrijving_SelectedFG = 255
    SELF.Q.AVP:VerpakkingOmschrijving_SelectedBG = -1
  ELSE
    SELF.Q.VVPar:PartijCelID_NormalFG = -1                 ! Set color values for VVPar:PartijCelID
    SELF.Q.VVPar:PartijCelID_NormalBG = -1
    SELF.Q.VVPar:PartijCelID_SelectedFG = -1
    SELF.Q.VVPar:PartijCelID_SelectedBG = -1
    SELF.Q.Par:PartijID_NormalFG = -1                      ! Set color values for Par:PartijID
    SELF.Q.Par:PartijID_NormalBG = -1
    SELF.Q.Par:PartijID_SelectedFG = -1
    SELF.Q.Par:PartijID_SelectedBG = -1
    SELF.Q.Par:ExternPartijnr_NormalFG = -1                ! Set color values for Par:ExternPartijnr
    SELF.Q.Par:ExternPartijnr_NormalBG = -1
    SELF.Q.Par:ExternPartijnr_SelectedFG = -1
    SELF.Q.Par:ExternPartijnr_SelectedBG = -1
    SELF.Q.Par:AanmaakDatum_DATE_NormalFG = -1             ! Set color values for Par:AanmaakDatum_DATE
    SELF.Q.Par:AanmaakDatum_DATE_NormalBG = -1
    SELF.Q.Par:AanmaakDatum_DATE_SelectedFG = -1
    SELF.Q.Par:AanmaakDatum_DATE_SelectedBG = -1
    SELF.Q.VVPar:BerekendeInkoopKGPrijs_NormalFG = -1      ! Set color values for VVPar:BerekendeInkoopKGPrijs
    SELF.Q.VVPar:BerekendeInkoopKGPrijs_NormalBG = -1
    SELF.Q.VVPar:BerekendeInkoopKGPrijs_SelectedFG = -1
    SELF.Q.VVPar:BerekendeInkoopKGPrijs_SelectedBG = -1
    SELF.Q.VVParT:VoorraadKG_NormalFG = -1                 ! Set color values for VVParT:VoorraadKG
    SELF.Q.VVParT:VoorraadKG_NormalBG = -1
    SELF.Q.VVParT:VoorraadKG_SelectedFG = -1
    SELF.Q.VVParT:VoorraadKG_SelectedBG = -1
    SELF.Q.LOC:PartijVerkoopKG_NormalFG = -1               ! Set color values for LOC:PartijVerkoopKG
    SELF.Q.LOC:PartijVerkoopKG_NormalBG = -1
    SELF.Q.LOC:PartijVerkoopKG_SelectedFG = -1
    SELF.Q.LOC:PartijVerkoopKG_SelectedBG = -1
    SELF.Q.LOC:BeschikbarePartijVoorraad_NormalFG = -1     ! Set color values for LOC:BeschikbarePartijVoorraad
    SELF.Q.LOC:BeschikbarePartijVoorraad_NormalBG = -1
    SELF.Q.LOC:BeschikbarePartijVoorraad_SelectedFG = -1
    SELF.Q.LOC:BeschikbarePartijVoorraad_SelectedBG = -1
    SELF.Q.ACel:CelOms_NormalFG = -1                       ! Set color values for ACel:CelOms
    SELF.Q.ACel:CelOms_NormalBG = -1
    SELF.Q.ACel:CelOms_SelectedFG = -1
    SELF.Q.ACel:CelOms_SelectedBG = -1
    SELF.Q.VVPar:Locatienaam_NormalFG = -1                 ! Set color values for VVPar:Locatienaam
    SELF.Q.VVPar:Locatienaam_NormalBG = -1
    SELF.Q.VVPar:Locatienaam_SelectedFG = -1
    SELF.Q.VVPar:Locatienaam_SelectedBG = -1
    SELF.Q.VVPar:VoorraadKG_NormalFG = -1                  ! Set color values for VVPar:VoorraadKG
    SELF.Q.VVPar:VoorraadKG_NormalBG = -1
    SELF.Q.VVPar:VoorraadKG_SelectedFG = -1
    SELF.Q.VVPar:VoorraadKG_SelectedBG = -1
    SELF.Q.LOC:VerkoopKG_NormalFG = -1                     ! Set color values for LOC:VerkoopKG
    SELF.Q.LOC:VerkoopKG_NormalBG = -1
    SELF.Q.LOC:VerkoopKG_SelectedFG = -1
    SELF.Q.LOC:VerkoopKG_SelectedBG = -1
    SELF.Q.LOC:BeschikbareVoorraad_NormalFG = -1           ! Set color values for LOC:BeschikbareVoorraad
    SELF.Q.LOC:BeschikbareVoorraad_NormalBG = -1
    SELF.Q.LOC:BeschikbareVoorraad_SelectedFG = -1
    SELF.Q.LOC:BeschikbareVoorraad_SelectedBG = -1
