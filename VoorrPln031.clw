...
ReturnValue          BYTE,AUTO
  ...
  CODE
        udpt.Init(UD,'BrowseTransfers','VoorrPln031.clw','VoorrPln.DLL','09/04/2014 @ 03:07PM')    
  ...
  If event() = event:VisibleOnDesktop !or event() = event:moved
    ds_VisibleOnDesktop()
     ...
     IF KEYCODE()=CtrlShiftP  
        UD.ShowProcedureInfo('BrowseTransfers',UD.SetApplicationName('VoorrPln','DLL'),QuickWindow{PROP:Hlp},'10/06/2011 @ 04:06PM','09/04/2014 @ 03:07PM','10/11/2024 @ 01:55PM')  
